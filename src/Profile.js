...
function Profile({ user }) {
    ...
    document.title = `${username} | Kahibalo`
    ...
    const bioSet = (e) => {
        ...
        if (101 - e.target.value.length < 0 || e.target.value.length === 0) {
            ...
            $('.saveButton')[0].style.backgroundColor = 'black';
        }
    }
    ...
    const bioUpdate = () => {
        if (101 - bio.length < 0 || bio.length === 0) {
            ...
            db.collection('users').doc(uid).update({
                ...
                alert("Por favor recarga la pagina para ver los cambios")
            )
        }
    }
    ...
    return (
        <div className="profile">
            ...
            >
                <div class="makeStyles-paper-1">
                    <div class="profileHead2">
                        <p>¿Estas seguro de que quieres cambiar tu foto de perfil? </p>
                        <progress value={progress} max="100" style={{ display: 'none' }} className="progress" />
                        <div className="buttons">
                            <button onClick={handleUpload}>Si</button>
            ...
            <div className="profile__topSection">
                ...
                <p onClick={addBio} className="bio">Añadir Bio</p>
                <div className="bioFields">
                    <textarea value={bio} placeholder="Describe who you are" onChange={bioSet} className="bioInput" />
                    <p>{`${101 - bio.length} caracteres restantes`}</p>
                    <div className="cancelAndSaveButtons">
                        <button onClick={collapseBio} >Cancelar</button>
                        <button onClick={bioUpdate} className="saveButton">Salvar</button>
                    </div>
                </div>
                ...
                <div className="profileHeader__options">
                    <div className="profileHeader__left">
                        <ul>
                            <li className="selected">Publicaciones</li>
                            <li>Sobre</li>
                            <li>Amigos</li>
                            <li>Fotos</li>
                            <li>Archivo</li>
                            <li>Mas</li>
                           <li className="rect editProfile"><img src="https://static.xx.fbcdn.net/rsrc.php/v3/yl/r/tmaz0VO75BB.png" /><p>Editar Perfil</p></li> 
                            <li className="rect addFriend"><img src="https://static.xx.fbcdn.net/rsrc.php/v3/yq/r/33EToHSZ94f.png" /><p>Añadir amigo</p></li> 
                        </ul>
                    </div>
                </div>
            </div>
