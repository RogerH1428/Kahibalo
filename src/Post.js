...
function Post({ postId, user, username, caption, imageUrl, noLikes, postUserId }) {
    ...
    return (
        <div className="post">
            ...
            <p>{noLikes} {noLikes == 1 ? "Me gusta" : "Me gusta"}</p>
            </div>
            ...
            <form onSubmit={postComment}>
                <div className="commentBox">
                    <Avatar
                        ...
                        src={user?.photoURL}
                    />
                    <input className="commentInputBox" type="text" placeholder="Escribe un comentario ... " value={comment} onChange={(e) => setComment(e.target.value)} />
