        ...
        <div className="register">
            ...
            <div className="register__container">
                ...
                <form>
                    ...
                    <h5 className="register__gender">Género</h5>
                    ...
                    Al hacer click en Registrarse, acepta nuestros{" "}
                        <span>Términos, Política de datos</span> y <span>Política de Cookie</span>. Tú
            puede recibir notificaciones por SMS de nuestra parte y puede optar por no participar en cualquier momento.
          </p>
                    ...
                    <Link to="/login">
                        <p className="register__login">¿Ya tienes una cuenta?</p>
                    </Link>
                </form>
            </div>
        </div >
