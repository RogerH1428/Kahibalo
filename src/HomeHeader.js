...
import { ArrowBack, ExitToApp, Search } from "@material-ui/icons";
  ...
  return (
    <div class="homeHeader">
      <div class="homeHeaderLogoAndSearch">
        <Link to="/">
          <img src={logo2} class="homeHeader__logo" />
        </Link>
        <div class="homeHeader__searchBack" onClick={collapseNavbar}>
          <ArrowBack class="searchBackIcon" />
        ...
        <input type="text" className="searchBox" placeholder="Buscar Kahibalo" onChange={updateSearchResults} />
...

          {
            notifications.length == 0 ? (
              <div className="noNotifDiv">
                ...
                <h1 className="NoNotif">Parece que no hay notificaciones activas</h1>
              </div>
            ) : (
                console.log()
              )
