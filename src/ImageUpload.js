        ...
        <div className="imageupload">
            ...
            >
                <div class="makeStyles-paper-1">
                    ...
                    <div class="inputForUpload">
                        ...
                        <textarea value={caption} onChange={(e) => setCaption(e.target.value)} rows="4" placeholder={`¿Qué estas pensando?, ${user?.displayName}?`} />
                    </div>
                    ...
                    <div className="publishOptions">
                        ...
                        <div class="right">
                            ...
                            <PhotoLibraryIcon style={{color:"green", width:"40px", height: "50px"}} onClick={uploadFileWithClick} />
            ...
            <div class="imageupload__container">
                <div class="postArea">
                    ...
                    <input value={caption} onChange={(e) => setCaption(e.target.value)} onClick={handleClickOpen('body')} placeholder={`¿Qué estas pensando?, ${user?.displayName}?`} />
                </div>
                <div class="hr" />
                <div class="options">
